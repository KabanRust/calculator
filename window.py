...
import sympy as sp
from constants import SIMPLE_OPERATORS, SIMPLE_FUNCTIONS, ENGINEERING_OPERATORS, ENGINEERING_FUNCTIONS, BASES
import modules
    ...
    def create_number_calculator_tab(self):
        ...
        for i, row in enumerate(buttons):
            for j, text in enumerate(row):
                ...
                button.clicked.connect(lambda t=text: self.on_number_button_click(t))
